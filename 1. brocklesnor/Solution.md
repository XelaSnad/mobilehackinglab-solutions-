...
From here I spun up a Python server to host a URL that is a Universal Link to the brokelesnor app, so we could intercept the traffic with Burp Suite. Clicking the link, or running something like:
